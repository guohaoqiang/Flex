...
leg2 = plt.legend(handles = patch_handles,loc='center right',scatterpoints = 1)

ax.text(xlim[0]*1.1,ylim[1]/1.1,'H100',horizontalalignment='left',verticalalignment='top')


#ax.annotate('', xy=(float(AI_L1[1]-0.01),float(FLOPS[1])), xytext=(float(AI_L2[1]+0.01),float(FLOPS[1])),
#            arrowprops=dict(arrowstyle="<->", connectionstyle="arc3"))
#ax.text((float(AI_L1[1])+float(AI_L2[1]))/2-0.03, float(FLOPS[1]+20), r'L1 reuse', fontsize=10, rotation=45)

#ax.annotate('', xy=(float(AI_L2[1]-0.01),float(FLOPS[1])), xytext=(float(AI_HBM[1]+0.01),float(FLOPS[1])),
#            arrowprops=dict(arrowstyle="<->", connectionstyle="arc3"))
#ax.text((float(AI_L2[1])+float(AI_HBM[1]))/2-0.35, float(FLOPS[1]+20), r'L2 reuse', fontsize=10)
