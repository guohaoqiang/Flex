...
/*
 *  This code is adapted from ASpT official: "http://gitlab.hpcrl.cse.ohio-state.edu/chong/ppopp19_ae/-/tree/master/ASpT_SpMM_GPU"
*/
...
void gen_bk128_wp4_tc4_r9_r16_strd( 
    ...
    if(bin_it < normalized_bin_size) {
        ...
        rg_k1  = __shfl_xor_sync(0xffff, rg_k1 , 0x1 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x1 );
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x1 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x1 );
        ...
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x1 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x1 );
        rg_k2  = __shfl_xor_sync(0xffff, rg_k2 , 0x2 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x2 );
        rg_v2  = __shfl_xor_sync(0xffff, rg_v2 , 0x2 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x2 );
        ...
        rg_v2  = __shfl_xor_sync(0xffff, rg_v2 , 0x2 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x2 );
        rg_k1  = __shfl_xor_sync(0xffff, rg_k1 , 0x4 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x4 );
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x4 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x4 );
        ...
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x4 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x4 );
        rg_k2  = __shfl_xor_sync(0xffff, rg_k2 , 0x8 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x8 );
        rg_v2  = __shfl_xor_sync(0xffff, rg_v2 , 0x8 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x8 );
        ...
        rg_v2  = __shfl_xor_sync(0xffff, rg_v2 , 0x8 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x8 );
        rg_k1  = __shfl_xor_sync(0xffff, rg_k1 , 0x10);
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x10);
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x10);
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x10);
        ...
        kk = __shfl_sync(0xffff, k, 0 );
        ss = __shfl_sync(0xffff, seg_size, 0 );
        if((lane_id>>4)==0&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k0 ;
        kk = __shfl_sync(0xffff, k, 4 );
        ss = __shfl_sync(0xffff, seg_size, 4 );
        if((lane_id>>4)==1&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k0 ;
        kk = __shfl_sync(0xffff, k, 8 );
        ss = __shfl_sync(0xffff, seg_size, 8 );
        if((lane_id>>4)==0&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k2 ;
        kk = __shfl_sync(0xffff, k, 12);
        ss = __shfl_sync(0xffff, seg_size, 12);
        if((lane_id>>4)==1&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k2 ;
        kk = __shfl_sync(0xffff, k, 16);
        ss = __shfl_sync(0xffff, seg_size, 16);
        if((lane_id>>4)==0&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k1 ;
        kk = __shfl_sync(0xffff, k, 20);
        ss = __shfl_sync(0xffff, seg_size, 20);
        if((lane_id>>4)==1&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k1 ;
        kk = __shfl_sync(0xffff, k, 24);
        ss = __shfl_sync(0xffff, seg_size, 24);
        if((lane_id>>4)==0&&lane_id-base<ss) keyB[kk+lane_id-base] = rg_k3 ;
        kk = __shfl_sync(0xffff, k, 28);
        ss = __shfl_sync(0xffff, seg_size, 28);
...
void gen_bk256_wp8_tc16_r65_r128_strd( 
    ...
    if(bin_it < normalized_bin_size) {
        ...
        rg_k1  = __shfl_xor_sync(0xffff, rg_k1 , 0x1 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x1 );
        rg_k5  = __shfl_xor_sync(0xffff, rg_k5 , 0x1 );
        rg_k7  = __shfl_xor_sync(0xffff, rg_k7 , 0x1 );
        rg_k9  = __shfl_xor_sync(0xffff, rg_k9 , 0x1 );
        rg_k11 = __shfl_xor_sync(0xffff, rg_k11, 0x1 );
        rg_k13 = __shfl_xor_sync(0xffff, rg_k13, 0x1 );
        rg_k15 = __shfl_xor_sync(0xffff, rg_k15, 0x1 );
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x1 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x1 );
        rg_v5  = __shfl_xor_sync(0xffff, rg_v5 , 0x1 );
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x1 );
        rg_v9  = __shfl_xor_sync(0xffff, rg_v9 , 0x1 );
        rg_v11 = __shfl_xor_sync(0xffff, rg_v11 , 0x1 );
        rg_v13 = __shfl_xor_sync(0xffff, rg_v13, 0x1 );
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x1 );
        if(lane_id&0x1 ) SWP(K, rg_k0 , rg_k1 , int, rg_v0 , rg_v1 );
        if(lane_id&0x1 ) SWP(K, rg_k2 , rg_k3 , int, rg_v2 , rg_v3 );
        ...
        rg_k2  = __shfl_xor_sync(0xffff, rg_k2 , 0x2 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x2 );
        rg_k6  = __shfl_xor_sync(0xffff, rg_k6 , 0x2 );
        rg_k7  = __shfl_xor_sync(0xffff, rg_k7 , 0x2 );
        rg_k10 = __shfl_xor_sync(0xffff, rg_k10, 0x2 );
        rg_k11 = __shfl_xor_sync(0xffff, rg_k11, 0x2 );
        rg_k14 = __shfl_xor_sync(0xffff, rg_k14, 0x2 );
        rg_k15 = __shfl_xor_sync(0xffff, rg_k15, 0x2 );
        rg_v2  = __shfl_xor_sync(0xffff, rg_v2 , 0x2 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x2 );
        rg_v6  = __shfl_xor_sync(0xffff, rg_v6 , 0x2 );
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x2 );
        rg_v10 = __shfl_xor_sync(0xffff, rg_v10 , 0x2 );
        rg_v11 = __shfl_xor_sync(0xffff, rg_v11 , 0x2 );
        rg_v14 = __shfl_xor_sync(0xffff, rg_v14, 0x2 );
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x2 );
        if(lane_id&0x2 ) SWP(K, rg_k0 , rg_k2 , int, rg_v0 , rg_v2 );
        if(lane_id&0x2 ) SWP(K, rg_k1 , rg_k3 , int, rg_v1 , rg_v3 );
        ...
        rg_v14 = __shfl_xor_sync(0xffff, rg_v14, 0x2 );
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x2 );
        rg_k4  = __shfl_xor_sync(0xffff, rg_k4 , 0x4 );
        rg_k5  = __shfl_xor_sync(0xffff, rg_k5 , 0x4 );
        rg_k6  = __shfl_xor_sync(0xffff, rg_k6 , 0x4 );
        rg_k7  = __shfl_xor_sync(0xffff, rg_k7 , 0x4 );
        rg_k12 = __shfl_xor_sync(0xffff, rg_k12, 0x4 );
        rg_k13 = __shfl_xor_sync(0xffff, rg_k13, 0x4 );
        rg_k14 = __shfl_xor_sync(0xffff, rg_k14, 0x4 );
        rg_k15 = __shfl_xor_sync(0xffff, rg_k15, 0x4 );
        rg_v4  = __shfl_xor_sync(0xffff, rg_v4 , 0x4 );
        rg_v5  = __shfl_xor_sync(0xffff, rg_v5 , 0x4 );
        rg_v6  = __shfl_xor_sync(0xffff, rg_v6 , 0x4 );
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x4 );
        rg_v12 = __shfl_xor_sync(0xffff, rg_v12 , 0x4 );
        rg_v13 = __shfl_xor_sync(0xffff, rg_v13, 0x4 );
        rg_v14 = __shfl_xor_sync(0xffff, rg_v14, 0x4 );
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x4 );
        ...
        rg_v14 = __shfl_xor_sync(0xffff, rg_v14, 0x4 );
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x4 );
        rg_k8  = __shfl_xor_sync(0xffff, rg_k8 , 0x8 );
        rg_k9  = __shfl_xor_sync(0xffff, rg_k9 , 0x8 );
        rg_k10 = __shfl_xor_sync(0xffff, rg_k10, 0x8 );
        rg_k11 = __shfl_xor_sync(0xffff, rg_k11, 0x8 );
        rg_k12 = __shfl_xor_sync(0xffff, rg_k12, 0x8 );
        rg_k13 = __shfl_xor_sync(0xffff, rg_k13, 0x8 );
        rg_k14 = __shfl_xor_sync(0xffff, rg_k14, 0x8 );
        rg_k15 = __shfl_xor_sync(0xffff, rg_k15, 0x8 );
        rg_v8  = __shfl_xor_sync(0xffff, rg_v8 , 0x8 );
        rg_v9  = __shfl_xor_sync(0xffff, rg_v9 , 0x8 );
        rg_v10 = __shfl_xor_sync(0xffff, rg_v10 , 0x8 );
        rg_v11 = __shfl_xor_sync(0xffff, rg_v11 , 0x8 );
        rg_v12 = __shfl_xor_sync(0xffff, rg_v12 , 0x8 );
        rg_v13 = __shfl_xor_sync(0xffff, rg_v13, 0x8 );
        rg_v14 = __shfl_xor_sync(0xffff, rg_v14, 0x8 );
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x8 );
        ...
        rg_k1  = __shfl_xor_sync(0xffff, rg_k1 , 0x10);
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x10);
        rg_k5  = __shfl_xor_sync(0xffff, rg_k5 , 0x10);
        rg_k7  = __shfl_xor_sync(0xffff, rg_k7 , 0x10);
        rg_k9  = __shfl_xor_sync(0xffff, rg_k9 , 0x10);
        rg_k11 = __shfl_xor_sync(0xffff, rg_k11, 0x10);
        rg_k13 = __shfl_xor_sync(0xffff, rg_k13, 0x10);
        rg_k15 = __shfl_xor_sync(0xffff, rg_k15, 0x10);
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x10);
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x10);
        rg_v5  = __shfl_xor_sync(0xffff, rg_v5 , 0x10);
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x10);
        rg_v9  = __shfl_xor_sync(0xffff, rg_v9 , 0x10);
        rg_v11 = __shfl_xor_sync(0xffff, rg_v11 , 0x10);
        rg_v13 = __shfl_xor_sync(0xffff, rg_v13, 0x10);
        rg_v15 = __shfl_xor_sync(0xffff, rg_v15, 0x10);
        if(lane_id&0x10) SWP(K, rg_k0 , rg_k1 , int, rg_v0 , rg_v1 );
        if(lane_id&0x10) SWP(K, rg_k2 , rg_k3 , int, rg_v2 , rg_v3 );
...
void gen_bk256_wp32_tc8_r129_r256_strd( 
    ...
    if(bin_it < normalized_bin_size) {
        ...
        rg_v6  = __shfl_xor_sync(0xffff, rg_v6 , 0x4 );
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x4 );
        rg_k1  = __shfl_xor_sync(0xffff, rg_k1 , 0x8 );
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x8 );
        rg_k5  = __shfl_xor_sync(0xffff, rg_k5 , 0x8 );
        rg_k7  = __shfl_xor_sync(0xffff, rg_k7 , 0x8 );
        rg_v1  = __shfl_xor_sync(0xffff, rg_v1 , 0x8 );
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x8 );
        rg_v5  = __shfl_xor_sync(0xffff, rg_v5 , 0x8 );
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x8 );
        ...
        rg_v5  = __shfl_xor_sync(0xffff, rg_v5 , 0x8 );
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x8 );
        rg_k2  = __shfl_xor_sync(0xffff, rg_k2 , 0x10);
        rg_k3  = __shfl_xor_sync(0xffff, rg_k3 , 0x10);
        rg_k6  = __shfl_xor_sync(0xffff, rg_k6 , 0x10);
        rg_k7  = __shfl_xor_sync(0xffff, rg_k7 , 0x10);
        rg_v2  = __shfl_xor_sync(0xffff, rg_v2 , 0x10);
        rg_v3  = __shfl_xor_sync(0xffff, rg_v3 , 0x10);
        rg_v6  = __shfl_xor_sync(0xffff, rg_v6 , 0x10);
        rg_v7  = __shfl_xor_sync(0xffff, rg_v7 , 0x10);
